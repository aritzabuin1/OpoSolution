...
logger.info({ primary: PRIMARY, secondary: SECONDARY, anthropicKey: process.env.ANTHROPIC_API_KEY ? 'SET' : 'MISSING', openaiKey: process.env.OPENAI_API_KEY ? 'SET' : 'MISSING' }, '[AI Provider] initialized')
