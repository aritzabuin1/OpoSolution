    ...
    <main className="mx-auto max-w-4xl px-4 py-12 space-y-16">
      ...
      <section className="py-12 bg-muted/30 rounded-2xl">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-center mb-8">¿Para quién es OpoRuta para Administración del Estado?</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>• Quieres saber qué artículos del BOE pregunta el tribunal (Radar del Tribunal)</li>
                <li>• Necesitas simulacros INAP reales con penalización -⅓</li>
              </ul>
            </div>
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>• Solo quieres test tipo trivial sin verificación legal</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <ClusterBlogTOC
        clusters={['auxiliar-c2', 'administrativo-c1', 'gace-a2']}
        title="Guías y artículos del blog — Administración del Estado"
