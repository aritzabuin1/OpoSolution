    ...
    <main className="mx-auto max-w-4xl px-4 py-12 space-y-16">
      ...
      <section className="py-12 bg-muted/30 rounded-2xl">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-center mb-8">¿Para quién es OpoRuta?</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>• Preparas cualquiera de las 12 oposiciones disponibles</li>
                <li>• Quieres una plataforma que cubra varias oposiciones sin pagar doble</li>
              </ul>
            </div>
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>• Buscas oposiciones autonómicas o locales (OpoRuta se centra en AGE + seguridad nacional)</li>
              </ul>
            </div>
          </div>
        </div>
