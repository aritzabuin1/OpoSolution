...
import { getNurtureFunnel, getWaitlistEntries, NURTURE_EMAIL_LABELS } from '@/lib/admin/user-explorer'
              ...
              <tbody>
                {funnel.filter(r => r.sent > 0).map((r) => (
                  <tr key={r.emailKey} className="border-b last:border-0">
                    <td className="py-2 pr-4 font-medium">{NURTURE_EMAIL_LABELS[r.emailKey] ?? r.emailKey}</td>
