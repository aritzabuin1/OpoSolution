...
import { BarChart3, LineChart, Server, Users, Activity, BookOpen, Calendar, ArrowRight, Search } from 'lucide-react'
          ...
          <Card className="h-full hover:border-primary/40 transition-colors">
            <CardContent className="pt-6 space-y-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Cobertura pSEO: artículos indexables, TL;DRs generados, top leyes y gaps de ingesta.
                </p>
              </div>
            </CardContent>
          </Card>
