-- =============================================================================
-- OpoRuta Migration 029: Logros motivacionales — §2.8.3
-- Autor: Claude / Aritz | Fecha: 2026-03-10
--
-- Añade 8 logros motivacionales (12 → 20 total).
-- Actualiza check_and_grant_logros con las nuevas condiciones.
--
-- Nuevos logros:
--   primer_simulacro   — primer simulacro completado
--   5_simulacros       — 5 simulacros completados
--   racha_14           — 14 días consecutivos
--   1000_preguntas     — 1000 preguntas respondidas
--   nota_90            — ≥90% en un test
--   3_perfectos        — 3 tests con 100%
--   bloque1_completo   — test en cada tema del Bloque I (1-16)
--   bloque2_completo   — test en cada tema del Bloque II (17-28)
-- =============================================================================
...
-- 2. Actualizar RPC con todos los logros
