...
/**
 * components/shared/ShareButton.tsx — §2.16.8
 *
 * Botones de compartición por canal para resultados de tests,
 * simulacros y sesiones de Caza-Trampas.
 * Cada canal (WhatsApp, X, Email, Copiar) formatea el contenido
 * de forma óptima para ese medio.
 */
